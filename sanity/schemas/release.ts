...
export const release = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: "object",
      description: "Sampled from this release's own artwork.",
      options: { collapsible: true, collapsed: true },
      fields: [
        { name: "accent", title: "Accent", type: "string" },
        { name: "accent2", title: "Secondary accent", type: "string" },
        { name: "ground", title: "Ground", type: "string" },
        { name: "raised", title: "Raised surface", type: "string" },
        { name: "paper", title: "Text colour", type: "string" },
        { name: "atmosphere", title: "Atmosphere note", type: "string" },
      ],
    },
    {
      name: "featured",
